...
// TODO: add this to loci.serializer.upickle or similar
object ValueRef {
  implicit def rw[V, P]: ReadWriter[ValueRef[V, P]] = macroRW[ValueRef[V, P]]
  implicit def rMSig: Reader[loci.runtime.Module.Signature] = macroR[loci.runtime.Module.Signature]
  implicit def rSig: Reader[loci.runtime.Peer.Signature] = macroR[loci.runtime.Peer.Signature]
  implicit def wMSig: Writer[loci.runtime.Module.Signature] = macroW[loci.runtime.Module.Signature]
  implicit def wSig: Writer[loci.runtime.Peer.Signature] = macroW[loci.runtime.Peer.Signature]
  implicit def rwSig: ReadWriter[loci.runtime.Peer.Signature] = macroRW[loci.runtime.Peer.Signature]
}
